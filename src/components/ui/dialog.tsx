...
function DialogFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex flex-col gap-2 p-4 pt-0 sm:flex-row sm:justify-end", className)}
      {...props}
    />
  )
}
